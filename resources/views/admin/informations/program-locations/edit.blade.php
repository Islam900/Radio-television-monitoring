    ...
    <div class="row mb-4">
        <div class="col-md-12 mb-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h3>{{ $program_location->name }}</h3>
                <a href="{{route('program-locations.index')}}">
            ...
            <hr>
            <form method="POST" action="{{route('program-locations.update', $program_location)}}">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input type="text" name="name" value="{{$program_location->name}}" id="" class="form-control">
                        @if($errors->has('name'))
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <select id="status" name="status"
                            ...
                            <option value="1" {{ $program_location->status == '1' ?  'selected' : '' }}>Aktiv</option>
                            <option value="0" {{ $program_location->status == '0' ?  'selected' : '' }}>Deaktiv</option>
                        </select>
