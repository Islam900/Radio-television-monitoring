...
@section('content')
    ...
    <div class="row mb-4">
        <div class="col-md-12 mb-4">
            ...
            <hr>
            <form method="POST" action="{{route('program-languages.update', $program_language)}}">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input type="text" name="name" value="{{$program_language->name}}" id="" class="form-control">
                        @if($errors->has('name'))
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <select id="status" name="status"
                            ...
                            <option value="1" {{ $program_language->status == '1' ?  'selected' : '' }}>Aktiv</option>
                            <option value="0" {{ $program_language->status == '0' ?  'selected' : '' }}>Deaktiv</option>
                        </select>
