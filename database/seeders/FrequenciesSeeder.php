    ...
    public function run(): void
    {
        ...
        foreach ($array as $item) {
            ...
            $tezlik = Frequencies::create([
                ...
                'program_names_id'    => $programName,
                'directions_id'       => $direction,
                'program_locations_id'=> $programLocation,
                'program_languages_id'=> $programLanguage,
...
//                'stations_id' => DB::table('stations')->where('station_name', 'LIKE', $item->station_id)->value('id')
//            ]);
        }
